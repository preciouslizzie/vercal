...
export default function AdminTab() {
    ...
    return (
      <div className="space-y-4">
        ...
        {!loading && managementSection === 'volunteers' && (
          <div className="space-y-4">
            <h3 className="text-xl font-bold">ðŸ‘¥ Manage Volunteers</h3>
        ...
        {!loading && managementSection === 'roles' && (
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-bold">ðŸŽ¯ Manage Roles</h3>
              <button
        ...
        {!loading && managementSection === 'schedules' && (
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-bold">ðŸ“… Manage Schedules</h3>
              <button
        ...
        {!loading && managementSection === 'announcements' && (
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-bold">ðŸ“¢ Manage Announcements</h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <h2 className="text-2xl font-bold">ðŸ”§ Admin Management Dashboard</h2>
