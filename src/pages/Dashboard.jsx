...
const Dashboard = () => {
  ...
  const goTo = (path) => navigate(`/dashboard/${path}`);
  ...
  const cards = [
    { title: 'Members', value: stats.members, icon: <FaUsers />, color: 'bg-indigo-600', path: 'members' },
    { title: 'Events', value: stats.events, icon: <FaCalendarAlt />, color: 'bg-emerald-600', path: 'events' },
    { title: 'Sermons', value: stats.sermons, icon: <FaBible />, color: 'bg-amber-600', path: 'sermons' },
    { title: 'Donations', value: stats.donations, icon: <FaDonate />, color: 'bg-rose-600', path: 'donations' },
    { title: 'Volunteers', value: stats.volunteer, icon: <FaHandsHelping />, color: 'bg-blue-600', path: 'volunteer' },
  ];
